<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="ViewPlan.aspx.cs" Inherits="SocialPanel.Admin.ViewPlan" %>
         ...
         $.ajax({
                 ...
                 var source =
            {
                ...
                datafields: [
                    ...
                    { name: 'LikeAmount', type: 'int' },
                    { name: 'MaxPhotos', type: 'int' }
                ...
                updaterow: function (rowid, rowdata, commit) {
                 ...
                 var editOrder = function (row, column, value, defaultHtml) {
                     ...
                     return '<a class="btn btn-info" href="/Admin/AddPlan.aspx?id=' + dataRecord.OrderId + '" target="_blank"><i class="icon-edit icon-white"></i>Edit</a>'
                 }
                 ...
                 $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'Plan Name', datafield: 'PlanName', width: 150},
                    { text: 'Like Amount', datafield: 'LikeAmount', width: 150},
                    { text: 'Max Photos', datafield: 'MaxPhotos', width: 150}
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>View Plans</h2>
                    <div class="box-icon">
