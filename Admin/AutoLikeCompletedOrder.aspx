<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="AutoLikeCompletedOrder.aspx.cs" Inherits="SocialPanel.Admin.AutoLikeCompletedOrder" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "../JquerPost.aspx/GetCompletedLikeOrdersForAdmin",
...
<div id="content" class="span10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li><a href="#">Completed Auto Like Orders</a> </li>
            </ul>
        </div>
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Completed Auto Like Orders</h2>
                    <div class="box-icon">
