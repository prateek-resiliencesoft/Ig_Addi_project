<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="ViewTokens.aspx.cs" Inherits="SocialPanel.Admin.ViewTokens" %>
     ...
     $(document).ready(function () {
         ...
         $.ajax({
                 ...
                 var source =
            {
                ...
                updaterow: function (rowid, rowdata, commit) {
                 ...
                 var editOrder = function (row, column, value, defaultHtml) {
                     ...
                     //return '<a href="/Admin/Account.aspx?id=' + dataRecord.Username + '" target="_blank"/>Edit</a>'
                     return '<a class="btn btn-info" href="/Admin/Account.aspx?id=' + dataRecord.Username + '" target="_blank"><i class="icon-edit icon-white"></i>Edit</a>'
                 }

                 var deleteOrder = function (row, column, value, defaultHtml) {
                     var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
                     return '<a class="btn btn-danger" href="javascript:void(o)" onclick="deleteMe(' + row + ');"><i class="icon-trash icon-white"></i>Delete</a>'
                 }
                 ...
                 $("#jqxgrid").jqxGrid(
            {
                ...
                //                },
                columns: [
                    { text: 'Delete', datafield: 'Delete', width: 72, cellsrenderer: deleteOrder },
                //{ text: 'Edit', datafield: 'Edit', width: 62, cellsrenderer: editOrder },
                    {text: 'UserID', datafield: 'UserID', width: 140 },
                    { text: 'UserName', datafield: 'UserName', width: 200 },
                    { text: 'AccessToken', datafield: 'AccessToken', width: 288 },
                //    { text: 'Proxy', datafield: 'Proxy', width: 110 },
                //  { text: 'Port', datafield: 'Port', width: 50 },
                //                    { text: 'P Username', datafield: 'Proxy Username', width: 100 },
                //                    { text: 'P Password', datafield: 'Proxy Password', width: 100 },
                    {text: 'IsActive', datafield: 'IsActive', width: 65, cellsrenderer: statusRender },
                    { text: 'DateTime', datafield: 'DateTime', width: 180, cellsformat: 'M/d/yyyy h:mm:ss tt' }
                ]
            });
    ...
    <script type="text/javascript">
        ...
        function deleteMe(RowId) {
         ...
         //   alert(UserID);
           // var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', RowId);
            //alert(dataRecord);
           // var QuestionId = dataRecord.toString();
           // alert(QuestionId);
        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                <div class="box-header well" data-original-title>
                    <h2>
                        <i class="icon-edit"></i>Accounts</h2>
                    <div class="box-icon">
